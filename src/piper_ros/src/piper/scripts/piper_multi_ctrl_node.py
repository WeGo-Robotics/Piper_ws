        ...
        while rclpy.ok():
            if self.auto_enable:
                while not enable_flag:
                    ...
                    enable_flag = all(piper.GetArmLowSpdInfoMsgs().motor_1.foc_status.driver_enable_status and 
        ...
        for piper in self.piper_interfaces:
            ...
            if(self.GetEnableFlag()):
                ...
                if(not all_zeros):
                    ...
                    else: piper.MotionCtrl_2(0x01, 0x01, 30)
                else: piper.MotionCtrl_2(0x01, 0x01, 30)
                ...
                if(self.gripper_exist):
                    if(len(joint_data.effort) == 7):
                        ...
                        piper.GripperCtrl(abs(gripper), gripper_effort, 0x01, 0)
                    else: piper.GripperCtrl(abs(gripper), 1000, 0x01, 0)
